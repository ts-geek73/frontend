...
const RegisterPage = ()=>{
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            console.log("pass1");
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].post("http://localhost:8000/register", formData, {
                headers: {
...
_s(RegisterPage, "fXdD2tnUY8wnwdcrkWmXzgyz2SE=", false, function() {
    return [
