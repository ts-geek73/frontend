...
const RegisterPage = ()=>{
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            console.log("pass1");
            const response = await __TURBOPACK__imported__module__$5b$externals$5d2f$axios__$5b$external$5d$__$28$axios$2c$__esm_import$29$__["default"].post("https://localhost:8000/register", formData, {
                headers: {
            ...
            if (response.status === 401) {
                setError("Email Exist , use another email");
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__03b80d._.js.map