    ...
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        const fetchCategoryTitles = async ()=>{
            if (categories && categories.length > 0) {
                try {
                    const response = await __TURBOPACK__imported__module__$5b$externals$5d2f$axios__$5b$external$5d$__$28$axios$2c$__esm_import$29$__["default"].get('http://localhost:8000/category'); // Fetch all categories
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("ol", {
                    ...
                    children: categories && categories.length > 0 ? categories.map((catId, index1)=>{
                        const category = categoryTitles.find((cat)=>cat.category_id === catId); // Find title
                        const catTitle = category ? category.title : catId; // Display title or ID if not found
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__72ed0c._.js.map